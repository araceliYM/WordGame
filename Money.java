...
public class Money implements Award
{
   ...
   public int displayWinnings(Players player, boolean gameResult)
   {
      ...
      if(gameResult)
      {
         System.out.println(player.getFirstName() + " " + player.getLastName() + ", that is correct! You won " + WIN_AMNT);
         returnAmnt = (int)Math.round(WIN_AMNT);
      }
      else
      {
         System.out.println(player.getFirstName() + " " + player.getLastName() + ", sorry, that is incorrect! You lost " + LOSE_AMNT);
